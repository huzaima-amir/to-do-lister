...
func GetEventByIDHandler(db *gorm.DB) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
        ...
        if err := db.Preload("SubTasks").
            Where("id = ? AND user_id = ?", eventID, userID). // ownership check for user
...
func DeleteEventHandler(db *gorm.DB) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
        ...
        if err := services.DeleteEvent(db, eventID); err != nil {
...
func DeleteSubTaskByEventHandler(db *gorm.DB) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
        ...
        if err := services.DeleteEventSubtaskByEvent(db, eventID, subID); err != nil {
            http.Error(w, err.Error(), http.StatusBadRequest)
            return
        }
...
func ToggleEventSubtaskHandler(db *gorm.DB) http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
        ...
        if err := services.ToggleEventSubtaskByEvent(db, eventID, subID, input.Checked); err != nil {
            http.Error(w, err.Error(), http.StatusBadRequest)
            return
        }
